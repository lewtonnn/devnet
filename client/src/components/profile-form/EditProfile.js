        ...
        <form className="form" onSubmit={e => onSubmit(e)}>
          ...
          <div className="form-group">
            <input type="text" placeholder="Location" name="location"
                   ...
                   onChange={e => onChange(e)}/>
            <small className="form-text">
              City & state suggested (eg. Amsterdam, Netherlands)
            </small>
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            <input
                ...
                name="githubusername" value={formData.githubusername}
                onChange={e => onChange(e)}
            />
            <small className="form-text">
          ...
          <div className="my-2">
            <button onClick={() => setDisplaySocialInputs(!displaySocialInputs)}
